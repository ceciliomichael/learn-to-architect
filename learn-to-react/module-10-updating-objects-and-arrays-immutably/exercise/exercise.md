# Exercise: Updating Objects and Arrays Immutably
...
The project passes strict type checking and its behavior demonstrates this rule: Replace state objects and arrays without mutation so React and readers can observe a new value.