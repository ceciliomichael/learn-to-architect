# Exercise: JSX, Expressions, and HTML Differences
...
The project passes strict type checking and its behavior demonstrates this rule: JSX describes a React element tree while JavaScript expressions supply values; use className, htmlFor, and camel-cased properties where React differs from HTML source.