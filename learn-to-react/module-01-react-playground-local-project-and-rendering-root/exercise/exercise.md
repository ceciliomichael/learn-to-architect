# Exercise: React Playground, Local Project, and Rendering Root
...
The project passes strict type checking and its behavior demonstrates this rule: Start in an official sandbox or a local strict TypeScript project, identify the DOM root, and render one application tree.