# Exercise: Effects for External Synchronization
...
The project passes strict type checking and its behavior demonstrates this rule: Effects synchronize React state with an external system and return cleanup for subscriptions or owned resources.