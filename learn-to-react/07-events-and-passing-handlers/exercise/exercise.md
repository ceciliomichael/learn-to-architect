# Exercise: Events and Passing Handlers
...
The project passes strict type checking and its behavior demonstrates this rule: Pass event handlers as functions and keep the action owner explicit.