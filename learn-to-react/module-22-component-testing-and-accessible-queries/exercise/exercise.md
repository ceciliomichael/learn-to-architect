# Exercise: Component Testing and Accessible Queries
...
The project passes strict type checking and its behavior demonstrates this rule: Component tests should query by accessible role, name, label, and visible behavior.