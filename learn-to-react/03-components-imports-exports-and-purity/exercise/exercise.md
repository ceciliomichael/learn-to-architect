# Exercise: Components, Imports, Exports, and Purity
...
The project passes strict type checking and its behavior demonstrates this rule: A component is a capitalized function that returns UI and remains pure during rendering; imports and exports define module ownership.