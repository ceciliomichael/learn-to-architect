# Exercise: State and Component Memory
...
The project passes strict type checking and its behavior demonstrates this rule: State stores component memory that affects rendering and each mounted component instance owns its state.