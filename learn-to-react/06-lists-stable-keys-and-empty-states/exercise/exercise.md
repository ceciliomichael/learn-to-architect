# Exercise: Lists, Stable Keys, and Empty States
...
The project passes strict type checking and its behavior demonstrates this rule: Render arrays with stable keys derived from data identity and provide an intentional empty state.