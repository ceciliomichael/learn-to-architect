# Exercise: Choosing Minimal State and Avoiding Contradictions
...
The project passes strict type checking and its behavior demonstrates this rule: Store the minimum complete state and derive everything else during rendering when possible.