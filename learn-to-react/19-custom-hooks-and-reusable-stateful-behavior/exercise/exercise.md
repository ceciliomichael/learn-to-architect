# Exercise: Custom Hooks and Reusable Stateful Behavior
...
The project passes strict type checking and its behavior demonstrates this rule: A custom hook reuses stateful behavior and follows Hook call rules while each caller retains independent state.