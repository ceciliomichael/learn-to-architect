# Exercise: Controlled and Uncontrolled Form Inputs
...
The project passes strict type checking and its behavior demonstrates this rule: Controlled inputs receive value and onChange from React state, while uncontrolled inputs keep current value in the DOM; choose deliberately.