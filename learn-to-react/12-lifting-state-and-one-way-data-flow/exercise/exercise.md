# Exercise: Lifting State and One-Way Data Flow
...
The project passes strict type checking and its behavior demonstrates this rule: Move shared state to the closest common owner and pass data down with actions up.