# Exercise: Deterministic Workflows and Model-Directed Decisions
...
1. Write a short contract describing the input, output, owner, and failure behavior for Deterministic Workflows and Model-Directed Decisions.
