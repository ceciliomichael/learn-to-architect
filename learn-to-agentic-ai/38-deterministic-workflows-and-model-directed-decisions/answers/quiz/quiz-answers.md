# Quiz Answers: Deterministic Workflows and Model-Directed Decisions

1. **What responsibility does this module add to the continuing project?**

   It adds Deterministic Workflows and Model-Directed Decisions with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
