# Exercise: Metrics, Thresholds, and Error Tradeoffs
...
1. Write a short contract describing the input, output, owner, and failure behavior for Metrics, Thresholds, and Error Tradeoffs.
