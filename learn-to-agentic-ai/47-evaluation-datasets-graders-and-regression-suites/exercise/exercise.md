# Exercise: Evaluation Datasets, Graders, and Regression Suites
...
1. Write a short contract describing the input, output, owner, and failure behavior for Evaluation Datasets, Graders, and Regression Suites.
