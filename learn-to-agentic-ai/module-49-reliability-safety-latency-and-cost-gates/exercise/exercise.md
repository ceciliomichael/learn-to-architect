# Exercise: Reliability, Safety, Latency, and Cost Gates
...
1. Write a short contract describing the input, output, owner, and failure behavior for Reliability, Safety, Latency, and Cost Gates.
