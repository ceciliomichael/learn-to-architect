# Module 37: Tenant Isolation and Memory Poisoning

## What you will learn

This module focuses on **Tenant Isolation and Memory Poisoning** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Tenant Isolation and Memory Poisoning
...
Continue to [Module 38](../module-38-deterministic-workflows-and-model-directed-decisions/README.md).