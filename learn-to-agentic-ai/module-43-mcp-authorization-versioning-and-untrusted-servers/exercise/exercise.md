# Exercise: MCP Authorization, Versioning, and Untrusted Servers
...
1. Write a short contract describing the input, output, owner, and failure behavior for MCP Authorization, Versioning, and Untrusted Servers.
