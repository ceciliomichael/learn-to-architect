# Quiz Answers: MCP Authorization, Versioning, and Untrusted Servers

1. **What responsibility does this module add to the continuing project?**

   It adds MCP Authorization, Versioning, and Untrusted Servers with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
