# Module 11: Tensors, Layers, Activations, and Backpropagation

## What you will learn

This module focuses on **Tensors, Layers, Activations, and Backpropagation** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Tensors store multidimensional numeric data, layers transform it, and backpropagation computes how parameters affected loss.
- Attention mixes information according to learned relevance scores.
- Transformer outputs remain probabilistic predictions rather than verified knowledge.
...
```text
Topic: Tensors, Layers, Activations, and Backpropagation
...
Continue to [Module 12](../module-12-tokens-tokenization-and-embedding-spaces/README.md).