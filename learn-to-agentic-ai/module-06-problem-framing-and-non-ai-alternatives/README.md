# Module 06: Problem Framing and Non-AI Alternatives

## What you will learn

This module focuses on **Problem Framing and Non-AI Alternatives** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Define the user decision, acceptable errors, available data, latency, cost, and fallback before selecting a model.
- Compare rules, search, ordinary software, and smaller models with the same evaluation cases.
- Do not automate a decision when no responsible success measure or escalation path exists.
...
```text
Topic: Problem Framing and Non-AI Alternatives
...
Continue to [Module 07](../module-07-regression-classification-loss-and-optimization/README.md).