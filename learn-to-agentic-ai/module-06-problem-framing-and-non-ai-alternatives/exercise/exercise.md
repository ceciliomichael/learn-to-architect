# Exercise: Problem Framing and Non-AI Alternatives
...
1. Write a short contract describing the input, output, owner, and failure behavior for Problem Framing and Non-AI Alternatives.
