# Quiz Answers: Problem Framing and Non-AI Alternatives

1. **What responsibility does this module add to the continuing project?**

   It adds Problem Framing and Non-AI Alternatives with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
