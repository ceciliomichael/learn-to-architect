# Quiz Answers: Read-Only Tools and Stable Tool Results

1. **What responsibility does this module add to the continuing project?**

   It adds Read-Only Tools and Stable Tool Results with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
