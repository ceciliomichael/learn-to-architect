# Module 14: Pretraining, Instruction Tuning, and Alignment

## What you will learn

This module focuses on **Pretraining, Instruction Tuning, and Alignment** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Pretraining learns statistical language patterns from large corpora; instruction tuning adapts behavior to task-like examples.
- Preference and safety training shape behavior but cannot guarantee truth or policy compliance.
- Application controls and evaluation remain necessary after model alignment.
...
```text
Topic: Pretraining, Instruction Tuning, and Alignment
...
Continue to [Module 15](../module-15-context-windows-decoding-hallucination-and-cost/README.md).