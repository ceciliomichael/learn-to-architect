# Exercise: Pretraining, Instruction Tuning, and Alignment
...
1. Write a short contract describing the input, output, owner, and failure behavior for Pretraining, Instruction Tuning, and Alignment.
