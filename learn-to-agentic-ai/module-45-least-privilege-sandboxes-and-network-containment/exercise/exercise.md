# Exercise: Least Privilege, Sandboxes, and Network Containment
...
1. Write a short contract describing the input, output, owner, and failure behavior for Least Privilege, Sandboxes, and Network Containment.
