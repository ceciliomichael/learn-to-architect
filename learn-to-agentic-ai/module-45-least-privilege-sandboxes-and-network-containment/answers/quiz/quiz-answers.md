# Quiz Answers: Least Privilege, Sandboxes, and Network Containment

1. **What responsibility does this module add to the continuing project?**

   It adds Least Privilege, Sandboxes, and Network Containment with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
