# Module 45: Least Privilege, Sandboxes, and Network Containment

## What you will learn

This module focuses on **Least Privilege, Sandboxes, and Network Containment** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Prompt injection is untrusted content attempting to change system behavior, including content retrieved from external sources.
- Contain impact with least privilege, isolated execution, network limits, allowlisted actions, approval, and output validation.
- A model instruction or guardrail is not a substitute for server-enforced authorization.
...
```text
Topic: Least Privilege, Sandboxes, and Network Containment
Project: a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution
...
Continue to [Module 46](../module-46-excessive-agency-secret-leakage-and-incident-response/README.md).