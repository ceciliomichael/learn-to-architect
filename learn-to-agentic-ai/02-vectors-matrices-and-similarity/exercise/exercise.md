# Exercise: Vectors, Matrices, and Similarity
...
1. Write a short contract describing the input, output, owner, and failure behavior for Vectors, Matrices, and Similarity.
