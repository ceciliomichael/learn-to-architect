# Module 03: Probability, Sampling, and Uncertainty

## What you will learn

This module focuses on **Probability, Sampling, and Uncertainty** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Probability describes uncertainty under assumptions, while samples are observations drawn from a population or process.
- Report uncertainty and sample limitations instead of presenting one score as certainty.
- Repeated experiments need controlled randomness and recorded seeds where reproducibility matters.
...
```text
Topic: Probability, Sampling, and Uncertainty
...
Continue to [Module 04](../module-04-metrics-thresholds-and-error-tradeoffs/README.md).