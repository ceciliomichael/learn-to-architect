# Module 07: Regression, Classification, Loss, and Optimization

## What you will learn

This module focuses on **Regression, Classification, Loss, and Optimization** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Features are model inputs, labels are target outcomes, and loss measures error during optimization.
- Regression predicts continuous values while classification predicts categories or category probabilities.
- Begin with a simple baseline so additional model complexity has measurable value.
...
```text
Topic: Regression, Classification, Loss, and Optimization
...
Continue to [Module 08](../module-08-features-labels-generalization-and-overfitting/README.md).