# Exercise: Tensors, Layers, Activations, and Backpropagation
...
1. Write a short contract describing the input, output, owner, and failure behavior for Tensors, Layers, Activations, and Backpropagation.
