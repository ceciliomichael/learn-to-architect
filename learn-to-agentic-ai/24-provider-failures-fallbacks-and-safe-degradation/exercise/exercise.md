# Exercise: Provider Failures, Fallbacks, and Safe Degradation
...
1. Write a short contract describing the input, output, owner, and failure behavior for Provider Failures, Fallbacks, and Safe Degradation.
