# Quiz Answers: Keyword, Vector, Hybrid Search, and Reranking

1. **What responsibility does this module add to the continuing project?**

   It adds Keyword, Vector, Hybrid Search, and Reranking with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
