# Exercise: Keyword, Vector, Hybrid Search, and Reranking
...
1. Write a short contract describing the input, output, owner, and failure behavior for Keyword, Vector, Hybrid Search, and Reranking.
