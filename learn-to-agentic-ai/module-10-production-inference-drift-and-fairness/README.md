# Module 10: Production Inference, Drift, and Fairness

## What you will learn

This module focuses on **Production Inference, Drift, and Fairness** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Inference turns current input into model output under a specific deployed model version.
- Data drift changes inputs; concept drift changes the relationship between input and desired outcome.
- Monitor real product outcomes and subgroup behavior without collecting unnecessary sensitive attributes.
...
```text
Topic: Production Inference, Drift, and Fairness
...
Continue to [Module 11](../module-11-tensors-layers-activations-and-backpropagation/README.md).