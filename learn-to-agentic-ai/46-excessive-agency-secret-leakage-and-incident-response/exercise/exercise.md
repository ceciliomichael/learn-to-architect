# Exercise: Excessive Agency, Secret Leakage, and Incident Response
...
1. Write a short contract describing the input, output, owner, and failure behavior for Excessive Agency, Secret Leakage, and Incident Response.
