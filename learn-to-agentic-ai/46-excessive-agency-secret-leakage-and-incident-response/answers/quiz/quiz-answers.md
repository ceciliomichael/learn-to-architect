# Quiz Answers: Excessive Agency, Secret Leakage, and Incident Response

1. **What responsibility does this module add to the continuing project?**

   It adds Excessive Agency, Secret Leakage, and Incident Response with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
