# Exercise: Prompt Injection and Untrusted Retrieved Content
...
1. Write a short contract describing the input, output, owner, and failure behavior for Prompt Injection and Untrusted Retrieved Content.
