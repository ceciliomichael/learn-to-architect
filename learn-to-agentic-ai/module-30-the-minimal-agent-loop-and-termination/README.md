# Module 30: The Minimal Agent Loop and Termination

## What you will learn

This module focuses on **The Minimal Agent Loop and Termination** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- An agent loop sends context to a model, receives a final answer or tool request, executes allowed tools, records results, and repeats under a strict limit.
- Tool arguments and results require runtime schemas and stable error behavior.
- Side effects need authorization, idempotency, approval where appropriate, and an audit record.
...
```text
Topic: The Minimal Agent Loop and Termination
...
Continue to [Module 31](../module-31-tool-schemas-descriptions-and-argument-validation/README.md).