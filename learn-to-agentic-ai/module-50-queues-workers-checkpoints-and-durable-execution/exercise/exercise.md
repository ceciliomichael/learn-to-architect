# Exercise: Queues, Workers, Checkpoints, and Durable Execution
...
1. Write a short contract describing the input, output, owner, and failure behavior for Queues, Workers, Checkpoints, and Durable Execution.
