# Module 22: Model Selection, Routing, Latency, and Cost

## What you will learn

This module focuses on **Model Selection, Routing, Latency, and Cost** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Model Selection, Routing, Latency, and Cost
...
Continue to [Module 23](../module-23-prompt-and-configuration-versioning/README.md).