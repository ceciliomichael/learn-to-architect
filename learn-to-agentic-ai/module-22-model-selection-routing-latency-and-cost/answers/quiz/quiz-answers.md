# Quiz Answers: Model Selection, Routing, Latency, and Cost

1. **What responsibility does this module add to the continuing project?**

   It adds Model Selection, Routing, Latency, and Cost with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
