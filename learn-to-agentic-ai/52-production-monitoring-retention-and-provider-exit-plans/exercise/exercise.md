# Exercise: Production Monitoring, Retention, and Provider Exit Plans
...
1. Write a short contract describing the input, output, owner, and failure behavior for Production Monitoring, Retention, and Provider Exit Plans.
