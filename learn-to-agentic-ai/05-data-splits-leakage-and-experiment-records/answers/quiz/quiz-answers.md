# Quiz Answers: Data Splits, Leakage, and Experiment Records

1. **What responsibility does this module add to the continuing project?**

   It adds Data Splits, Leakage, and Experiment Records with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
