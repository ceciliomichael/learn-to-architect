# Exercise: Document Ingestion, Parsing, and Source Ownership
...
1. Write a short contract describing the input, output, owner, and failure behavior for Document Ingestion, Parsing, and Source Ownership.
