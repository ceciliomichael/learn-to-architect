# Quiz Answers: Queues, Workers, Checkpoints, and Durable Execution

1. **What responsibility does this module add to the continuing project?**

   It adds Queues, Workers, Checkpoints, and Durable Execution with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
