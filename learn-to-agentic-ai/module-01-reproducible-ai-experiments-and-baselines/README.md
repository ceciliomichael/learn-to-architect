# Module 01: Reproducible AI Experiments and Baselines

## What you will learn

This module focuses on **Reproducible AI Experiments and Baselines** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- A baseline is the simplest credible approach against which an AI change is compared.
- Record dataset version, code revision, model, prompt, parameters, environment, and metric definitions.
- Repeat runs where randomness can change the conclusion.
...
```text
Topic: Reproducible AI Experiments and Baselines
...
Continue to [Module 02](../module-02-vectors-matrices-and-similarity/README.md).