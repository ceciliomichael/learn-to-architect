# Exercise: Reproducible AI Experiments and Baselines
...
1. Write a short contract describing the input, output, owner, and failure behavior for Reproducible AI Experiments and Baselines.
