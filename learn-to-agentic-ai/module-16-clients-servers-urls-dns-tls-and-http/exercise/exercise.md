# Exercise: Clients, Servers, URLs, DNS, TLS, and HTTP
...
1. Write a short contract describing the input, output, owner, and failure behavior for Clients, Servers, URLs, DNS, TLS, and HTTP.
