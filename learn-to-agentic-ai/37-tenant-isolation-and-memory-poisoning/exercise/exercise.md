# Exercise: Tenant Isolation and Memory Poisoning
...
1. Write a short contract describing the input, output, owner, and failure behavior for Tenant Isolation and Memory Poisoning.
