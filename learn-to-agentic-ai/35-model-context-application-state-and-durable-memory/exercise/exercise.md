# Exercise: Model Context, Application State, and Durable Memory
...
1. Write a short contract describing the input, output, owner, and failure behavior for Model Context, Application State, and Durable Memory.
