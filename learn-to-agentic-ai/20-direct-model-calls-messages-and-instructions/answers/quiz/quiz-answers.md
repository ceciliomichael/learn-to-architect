# Quiz Answers: Direct Model Calls, Messages, and Instructions

1. **What responsibility does this module add to the continuing project?**

   It adds Direct Model Calls, Messages, and Instructions with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
