# Exercise: Direct Model Calls, Messages, and Instructions
...
1. Write a short contract describing the input, output, owner, and failure behavior for Direct Model Calls, Messages, and Instructions.
