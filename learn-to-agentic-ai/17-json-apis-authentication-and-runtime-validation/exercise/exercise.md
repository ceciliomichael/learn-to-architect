# Exercise: JSON APIs, Authentication, and Runtime Validation
...
1. Write a short contract describing the input, output, owner, and failure behavior for JSON APIs, Authentication, and Runtime Validation.
