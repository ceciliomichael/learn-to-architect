# Quiz Answers: MCP Tools, Resources, Prompts, and Transports

1. **What responsibility does this module add to the continuing project?**

   It adds MCP Tools, Resources, Prompts, and Transports with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
