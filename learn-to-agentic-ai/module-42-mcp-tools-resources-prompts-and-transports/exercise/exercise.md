# Exercise: MCP Tools, Resources, Prompts, and Transports
...
1. Write a short contract describing the input, output, owner, and failure behavior for MCP Tools, Resources, Prompts, and Transports.
