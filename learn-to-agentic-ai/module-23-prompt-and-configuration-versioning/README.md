# Module 23: Prompt and Configuration Versioning

## What you will learn

This module focuses on **Prompt and Configuration Versioning** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Prompt and Configuration Versioning
...
Continue to [Module 24](../module-24-provider-failures-fallbacks-and-safe-degradation/README.md).