# Module 05: Data Splits, Leakage, and Experiment Records

## What you will learn

This module focuses on **Data Splits, Leakage, and Experiment Records** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Data Splits, Leakage, and Experiment Records
...
Continue to [Module 06](../module-06-problem-framing-and-non-ai-alternatives/README.md).