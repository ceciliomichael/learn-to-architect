# Exercise: Regression, Classification, Loss, and Optimization
...
1. Write a short contract describing the input, output, owner, and failure behavior for Regression, Classification, Loss, and Optimization.
