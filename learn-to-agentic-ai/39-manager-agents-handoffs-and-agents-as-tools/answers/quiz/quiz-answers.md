# Quiz Answers: Manager Agents, Handoffs, and Agents as Tools

1. **What responsibility does this module add to the continuing project?**

   It adds Manager Agents, Handoffs, and Agents as Tools with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
