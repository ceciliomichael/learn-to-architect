# Exercise: Features, Labels, Generalization, and Overfitting
...
1. Write a short contract describing the input, output, owner, and failure behavior for Features, Labels, Generalization, and Overfitting.
