# Quiz Answers: MCP Hosts, Clients, Servers, and Capabilities

1. **What responsibility does this module add to the continuing project?**

   It adds MCP Hosts, Clients, Servers, and Capabilities with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
