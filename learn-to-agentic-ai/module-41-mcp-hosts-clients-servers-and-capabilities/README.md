# Module 41: MCP Hosts, Clients, Servers, and Capabilities

## What you will learn

This module focuses on **MCP Hosts, Clients, Servers, and Capabilities** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- DNS finds an address, transport establishes communication, TLS protects and authenticates the channel, and HTTP defines application semantics.
- Every hop through a proxy or load balancer changes which connection information can be trusted.
- Timeouts and certificate validation are part of correctness, not optional deployment polish.
...
```text
Topic: MCP Hosts, Clients, Servers, and Capabilities
...
Continue to [Module 42](../module-42-mcp-tools-resources-prompts-and-transports/README.md).