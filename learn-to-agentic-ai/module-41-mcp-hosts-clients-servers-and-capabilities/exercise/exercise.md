# Exercise: MCP Hosts, Clients, Servers, and Capabilities
...
1. Write a short contract describing the input, output, owner, and failure behavior for MCP Hosts, Clients, Servers, and Capabilities.
