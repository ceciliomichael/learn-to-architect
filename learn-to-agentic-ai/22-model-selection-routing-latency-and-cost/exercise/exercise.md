# Exercise: Model Selection, Routing, Latency, and Cost
...
1. Write a short contract describing the input, output, owner, and failure behavior for Model Selection, Routing, Latency, and Cost.
