# Module 20: Direct Model Calls, Messages, and Instructions

## What you will learn

This module focuses on **Direct Model Calls, Messages, and Instructions** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Keep system policy, user input, tool results, and retrieved content distinguishable in the model input.
- Validate structured output after generation and reject shapes or values outside the contract.
- Version model, prompt, tools, and decoding settings together so evaluation results can be reproduced.
...
```text
Topic: Direct Model Calls, Messages, and Instructions
...
Continue to [Module 21](../module-21-structured-model-output-and-schema-validation/README.md).