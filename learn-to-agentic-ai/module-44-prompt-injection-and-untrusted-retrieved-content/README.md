# Module 44: Prompt Injection and Untrusted Retrieved Content

## What you will learn

This module focuses on **Prompt Injection and Untrusted Retrieved Content** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Prompt Injection and Untrusted Retrieved Content
...
Continue to [Module 45](../module-45-least-privilege-sandboxes-and-network-containment/README.md).