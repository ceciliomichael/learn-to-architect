# Quiz Answers: Prompt Injection and Untrusted Retrieved Content

1. **What responsibility does this module add to the continuing project?**

   It adds Prompt Injection and Untrusted Retrieved Content with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
