# Quiz Answers: Pretraining, Instruction Tuning, and Alignment

1. **What responsibility does this module add to the continuing project?**

   It adds Pretraining, Instruction Tuning, and Alignment with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
