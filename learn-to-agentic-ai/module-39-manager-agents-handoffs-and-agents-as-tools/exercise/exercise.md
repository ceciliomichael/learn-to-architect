# Exercise: Manager Agents, Handoffs, and Agents as Tools
...
1. Write a short contract describing the input, output, owner, and failure behavior for Manager Agents, Handoffs, and Agents as Tools.
