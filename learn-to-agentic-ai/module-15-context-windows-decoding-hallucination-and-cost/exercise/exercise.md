# Exercise: Context Windows, Decoding, Hallucination, and Cost
...
1. Write a short contract describing the input, output, owner, and failure behavior for Context Windows, Decoding, Hallucination, and Cost.
