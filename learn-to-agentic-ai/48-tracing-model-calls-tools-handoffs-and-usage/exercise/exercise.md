# Exercise: Tracing Model Calls, Tools, Handoffs, and Usage
...
1. Write a short contract describing the input, output, owner, and failure behavior for Tracing Model Calls, Tools, Handoffs, and Usage.
