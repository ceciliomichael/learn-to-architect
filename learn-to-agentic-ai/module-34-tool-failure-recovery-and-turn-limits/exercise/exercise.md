# Exercise: Tool Failure, Recovery, and Turn Limits
...
1. Write a short contract describing the input, output, owner, and failure behavior for Tool Failure, Recovery, and Turn Limits.
