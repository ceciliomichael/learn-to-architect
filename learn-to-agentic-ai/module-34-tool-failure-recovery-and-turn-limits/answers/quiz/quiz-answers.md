# Quiz Answers: Tool Failure, Recovery, and Turn Limits

1. **What responsibility does this module add to the continuing project?**

   It adds Tool Failure, Recovery, and Turn Limits with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
