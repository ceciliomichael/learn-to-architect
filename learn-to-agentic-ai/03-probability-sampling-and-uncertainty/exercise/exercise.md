# Exercise: Probability, Sampling, and Uncertainty
...
1. Write a short contract describing the input, output, owner, and failure behavior for Probability, Sampling, and Uncertainty.
