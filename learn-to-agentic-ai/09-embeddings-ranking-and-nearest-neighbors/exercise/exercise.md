# Exercise: Embeddings, Ranking, and Nearest Neighbors
...
1. Write a short contract describing the input, output, owner, and failure behavior for Embeddings, Ranking, and Nearest Neighbors.
