# Exercise: Model and Prompt Upgrades, Rollouts, and Rollback
...
1. Write a short contract describing the input, output, owner, and failure behavior for Model and Prompt Upgrades, Rollouts, and Rollback.
