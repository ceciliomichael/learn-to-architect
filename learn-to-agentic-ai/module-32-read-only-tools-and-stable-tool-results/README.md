# Module 32: Read-Only Tools and Stable Tool Results

## What you will learn

This module focuses on **Read-Only Tools and Stable Tool Results** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Read-Only Tools and Stable Tool Results
...
Continue to [Module 33](../module-33-side-effects-idempotency-and-approval-gates/README.md).