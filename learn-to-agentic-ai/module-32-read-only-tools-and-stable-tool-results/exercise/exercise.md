# Exercise: Read-Only Tools and Stable Tool Results
...
1. Write a short contract describing the input, output, owner, and failure behavior for Read-Only Tools and Stable Tool Results.
