# Module 35: Model Context, Application State, and Durable Memory

## What you will learn

This module focuses on **Model Context, Application State, and Durable Memory** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Model context is temporary input for one run; application state is authoritative data; memory is selected information reused later.
- Store source, timestamp, tenant, expiry, and confidence with remembered information.
- Model-written summaries and memories remain untrusted until validated against owned records.
...
```text
Topic: Model Context, Application State, and Durable Memory
...
Continue to [Module 36](../module-36-summaries-preferences-expiry-and-deletion/README.md).