# Exercise: Attention and Transformer Structure
...
1. Write a short contract describing the input, output, owner, and failure behavior for Attention and Transformer Structure.
