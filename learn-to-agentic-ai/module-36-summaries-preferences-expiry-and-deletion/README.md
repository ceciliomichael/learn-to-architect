# Module 36: Summaries, Preferences, Expiry, and Deletion

## What you will learn

This module focuses on **Summaries, Preferences, Expiry, and Deletion** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Summaries, Preferences, Expiry, and Deletion
...
Continue to [Module 37](../module-37-tenant-isolation-and-memory-poisoning/README.md).