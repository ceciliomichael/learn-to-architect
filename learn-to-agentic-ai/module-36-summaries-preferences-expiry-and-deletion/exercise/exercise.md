# Exercise: Summaries, Preferences, Expiry, and Deletion
...
1. Write a short contract describing the input, output, owner, and failure behavior for Summaries, Preferences, Expiry, and Deletion.
