# Exercise: Retrieval and Answer Evaluation
...
1. Write a short contract describing the input, output, owner, and failure behavior for Retrieval and Answer Evaluation.
