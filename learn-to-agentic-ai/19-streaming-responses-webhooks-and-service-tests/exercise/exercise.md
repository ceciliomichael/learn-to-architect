# Exercise: Streaming Responses, Webhooks, and Service Tests
...
1. Write a short contract describing the input, output, owner, and failure behavior for Streaming Responses, Webhooks, and Service Tests.
