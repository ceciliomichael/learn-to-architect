# Module 02: Vectors, Matrices, and Similarity

## What you will learn

This module focuses on **Vectors, Matrices, and Similarity** as part of Agentic AI Engineering. The goal is to understand the responsibility, use it in a controlled agent system with retrieval, tools, approval, evaluation, tracing, and durable execution, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Vectors, Matrices, and Similarity
...
Continue to [Module 03](../module-03-probability-sampling-and-uncertainty/README.md).