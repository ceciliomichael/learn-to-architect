# Exercise: Table Grain, Facts, Dimensions, and Measures
...
1. Write a short contract describing the input, output, owner, and failure behavior for Table Grain, Facts, Dimensions, and Measures.
