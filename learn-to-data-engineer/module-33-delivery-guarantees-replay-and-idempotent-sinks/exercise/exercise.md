# Exercise: Delivery Guarantees, Replay, and Idempotent Sinks
...
1. Write a short contract describing the input, output, owner, and failure behavior for Delivery Guarantees, Replay, and Idempotent Sinks.
