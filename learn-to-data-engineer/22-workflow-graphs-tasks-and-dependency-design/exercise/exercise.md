# Exercise: Workflow Graphs, Tasks, and Dependency Design
...
1. Write a short contract describing the input, output, owner, and failure behavior for Workflow Graphs, Tasks, and Dependency Design.
