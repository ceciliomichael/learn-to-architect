# Exercise: Natural Keys, Surrogate Keys, and Slowly Changing Dimensions

Apply this module to the continuing project: a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets.

1. Write a short contract describing the input, output, owner, and failure behavior for Natural Keys, Surrogate Keys, and Slowly Changing Dimensions.
