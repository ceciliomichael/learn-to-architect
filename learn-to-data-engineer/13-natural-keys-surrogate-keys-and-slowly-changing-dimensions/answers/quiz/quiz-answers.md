# Quiz Answers: Natural Keys, Surrogate Keys, and Slowly Changing Dimensions

1. **What responsibility does this module add to the continuing project?**

   It adds Natural Keys, Surrogate Keys, and Slowly Changing Dimensions with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
