# Quiz Answers: dbt Projects, Models, Sources, and Dependencies

1. **What responsibility does this module add to the continuing project?**

   It adds dbt Projects, Models, Sources, and Dependencies with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
