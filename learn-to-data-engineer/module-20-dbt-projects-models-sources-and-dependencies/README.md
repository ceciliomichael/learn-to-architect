...
- dbt organizes SQL transformations as a dependency graph; it does not replace warehouse design or source validation.
- Test keys, relationships, accepted values, freshness, and business invariants at the layer that owns them.
- Reconciliation compares counts, totals, and control values between source and destination.
...
```text
Topic: dbt Projects, Models, Sources, and Dependencies
...
Continue to [Module 21](../module-21-transformation-tests-documentation-and-reconciliation/README.md).