# Exercise: dbt Projects, Models, Sources, and Dependencies
...
1. Write a short contract describing the input, output, owner, and failure behavior for dbt Projects, Models, Sources, and Dependencies.
