# Exercise: Events, Producers, Consumers, and Kafka Topics
...
1. Write a short contract describing the input, output, owner, and failure behavior for Events, Producers, Consumers, and Kafka Topics.
