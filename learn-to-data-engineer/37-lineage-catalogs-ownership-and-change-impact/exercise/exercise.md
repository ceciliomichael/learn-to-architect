# Exercise: Lineage, Catalogs, Ownership, and Change Impact
...
1. Write a short contract describing the input, output, owner, and failure behavior for Lineage, Catalogs, Ownership, and Change Impact.
