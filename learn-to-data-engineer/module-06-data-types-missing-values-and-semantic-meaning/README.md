# Module 06: Data Types, Missing Values, and Semantic Meaning

## What you will learn

This module focuses on **Data Types, Missing Values, and Semantic Meaning** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- A physical type controls representation, while semantic meaning explains what the value represents and which operations are valid.
- Missing, unknown, not applicable, and not yet observed are different states even when one null marker stores them.
- Units, time zones, precision, and allowed ranges belong in the contract.
...
```text
Topic: Data Types, Missing Values, and Semantic Meaning
...
Continue to [Module 07](../module-07-csv-json-and-newline-delimited-json/README.md).