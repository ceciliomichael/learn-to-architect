# Exercise: Privacy, Retention, Access Control, and Audit Evidence
...
1. Write a short contract describing the input, output, owner, and failure behavior for Privacy, Retention, Access Control, and Audit Evidence.
