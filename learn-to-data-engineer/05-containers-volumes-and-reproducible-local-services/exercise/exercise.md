# Exercise: Containers, Volumes, and Reproducible Local Services
...
1. Write a short contract describing the input, output, owner, and failure behavior for Containers, Volumes, and Reproducible Local Services.
