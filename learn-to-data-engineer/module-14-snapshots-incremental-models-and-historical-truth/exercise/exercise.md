# Exercise: Snapshots, Incremental Models, and Historical Truth
...
1. Write a short contract describing the input, output, owner, and failure behavior for Snapshots, Incremental Models, and Historical Truth.
