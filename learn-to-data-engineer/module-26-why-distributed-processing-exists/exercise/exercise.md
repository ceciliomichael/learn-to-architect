# Exercise: Why Distributed Processing Exists
...
1. Write a short contract describing the input, output, owner, and failure behavior for Why Distributed Processing Exists.
