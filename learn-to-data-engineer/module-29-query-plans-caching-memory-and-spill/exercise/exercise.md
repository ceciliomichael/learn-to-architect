# Exercise: Query Plans, Caching, Memory, and Spill
...
1. Write a short contract describing the input, output, owner, and failure behavior for Query Plans, Caching, Memory, and Spill.
