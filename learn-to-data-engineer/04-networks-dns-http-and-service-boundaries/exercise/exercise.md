# Exercise: Networks, DNS, HTTP, and Service Boundaries
...
1. Write a short contract describing the input, output, owner, and failure behavior for Networks, DNS, HTTP, and Service Boundaries.
