# Quiz Answers: Change Data Capture and Source Ordering

1. **What responsibility does this module add to the continuing project?**

   It adds Change Data Capture and Source Ordering with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
