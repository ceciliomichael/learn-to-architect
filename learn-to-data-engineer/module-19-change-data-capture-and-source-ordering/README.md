# Module 19: Change Data Capture and Source Ordering

## What you will learn

This module focuses on **Change Data Capture and Source Ordering** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Change data capture represents inserts, updates, and deletes from a source log or comparison process.
- Consumers need a stable position, ordering scope, and rule for snapshots followed by changes.
- Schema changes and deletes must be represented explicitly.
...
```text
Topic: Change Data Capture and Source Ordering
...
Continue to [Module 20](../module-20-dbt-projects-models-sources-and-dependencies/README.md).