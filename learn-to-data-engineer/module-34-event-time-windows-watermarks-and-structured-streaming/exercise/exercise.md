# Exercise: Event Time, Windows, Watermarks, and Structured Streaming
...
1. Write a short contract describing the input, output, owner, and failure behavior for Event Time, Windows, Watermarks, and Structured Streaming.
