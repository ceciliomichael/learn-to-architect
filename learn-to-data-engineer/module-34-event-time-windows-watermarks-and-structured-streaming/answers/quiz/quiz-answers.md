# Quiz Answers: Event Time, Windows, Watermarks, and Structured Streaming

1. **What responsibility does this module add to the continuing project?**

   It adds Event Time, Windows, Watermarks, and Structured Streaming with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
