# Module 37: Lineage, Catalogs, Ownership, and Change Impact

## What you will learn

This module focuses on **Lineage, Catalogs, Ownership, and Change Impact** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Lineage, Catalogs, Ownership, and Change Impact
...
Continue to [Module 38](../module-38-privacy-retention-access-control-and-audit-evidence/README.md).