# Quiz Answers: Explicit Schemas, Data Contracts, and Schema Evolution

1. **What responsibility does this module add to the continuing project?**

   It adds Explicit Schemas, Data Contracts, and Schema Evolution with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
