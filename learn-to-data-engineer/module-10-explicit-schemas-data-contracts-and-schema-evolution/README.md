# Module 10: Explicit Schemas, Data Contracts, and Schema Evolution

## What you will learn

This module focuses on **Explicit Schemas, Data Contracts, and Schema Evolution** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Explicit Schemas, Data Contracts, and Schema Evolution
...
Continue to [Module 11](../module-11-operational-databases-and-analytical-systems/README.md).