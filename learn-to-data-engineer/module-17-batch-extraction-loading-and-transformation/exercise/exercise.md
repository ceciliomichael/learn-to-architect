# Exercise: Batch Extraction, Loading, and Transformation
...
1. Write a short contract describing the input, output, owner, and failure behavior for Batch Extraction, Loading, and Transformation.
