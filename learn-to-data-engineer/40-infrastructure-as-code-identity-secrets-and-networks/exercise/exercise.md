# Exercise: Infrastructure as Code, Identity, Secrets, and Networks
...
1. Write a short contract describing the input, output, owner, and failure behavior for Infrastructure as Code, Identity, Secrets, and Networks.
