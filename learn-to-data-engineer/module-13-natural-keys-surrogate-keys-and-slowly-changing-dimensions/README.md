# Module 13: Natural Keys, Surrogate Keys, and Slowly Changing Dimensions

## What you will learn

This module focuses on **Natural Keys, Surrogate Keys, and Slowly Changing Dimensions** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Grain states exactly what one row represents and must be decided before choosing columns.
- Facts record measurable events; dimensions provide descriptive context.
- Joining tables at incompatible grains creates duplicated measures and incorrect totals.
...
```text
Topic: Natural Keys, Surrogate Keys, and Slowly Changing Dimensions
...
Continue to [Module 14](../module-14-snapshots-incremental-models-and-historical-truth/README.md).