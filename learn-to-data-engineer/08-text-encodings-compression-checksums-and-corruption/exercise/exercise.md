# Exercise: Text Encodings, Compression, Checksums, and Corruption
...
1. Write a short contract describing the input, output, owner, and failure behavior for Text Encodings, Compression, Checksums, and Corruption.
