# Exercise: CSV, JSON, and Newline-Delimited JSON
...
1. Write a short contract describing the input, output, owner, and failure behavior for CSV, JSON, and Newline-Delimited JSON.
