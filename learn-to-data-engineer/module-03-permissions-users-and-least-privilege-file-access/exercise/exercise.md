# Exercise: Permissions, Users, and Least-Privilege File Access
...
1. Write a short contract describing the input, output, owner, and failure behavior for Permissions, Users, and Least-Privilege File Access.
