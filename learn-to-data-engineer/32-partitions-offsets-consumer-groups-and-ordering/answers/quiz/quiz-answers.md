# Quiz Answers: Partitions, Offsets, Consumer Groups, and Ordering

1. **What responsibility does this module add to the continuing project?**

   It adds Partitions, Offsets, Consumer Groups, and Ordering with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
