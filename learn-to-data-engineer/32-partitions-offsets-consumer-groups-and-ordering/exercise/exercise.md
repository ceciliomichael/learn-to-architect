# Exercise: Partitions, Offsets, Consumer Groups, and Ordering
...
1. Write a short contract describing the input, output, owner, and failure behavior for Partitions, Offsets, Consumer Groups, and Ordering.
