# Module 18: Idempotency, Checkpoints, and Safe Backfills

## What you will learn

This module focuses on **Idempotency, Checkpoints, and Safe Backfills** as part of Data Engineering. The goal is to understand the responsibility, use it in a versioned data platform that ingests, validates, transforms, serves, and monitors trustworthy datasets, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Idempotency, Checkpoints, and Safe Backfills
...
Continue to [Module 19](../module-19-change-data-capture-and-source-ordering/README.md).