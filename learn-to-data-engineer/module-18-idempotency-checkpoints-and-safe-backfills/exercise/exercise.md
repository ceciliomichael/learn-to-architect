# Exercise: Idempotency, Checkpoints, and Safe Backfills
...
1. Write a short contract describing the input, output, owner, and failure behavior for Idempotency, Checkpoints, and Safe Backfills.
