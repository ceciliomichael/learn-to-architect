# Exercise: Reliable Spark Batch Jobs and Recovery
...
1. Write a short contract describing the input, output, owner, and failure behavior for Reliable Spark Batch Jobs and Recovery.
