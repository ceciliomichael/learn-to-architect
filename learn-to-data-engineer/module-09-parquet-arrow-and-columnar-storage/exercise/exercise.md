# Exercise: Parquet, Arrow, and Columnar Storage
...
1. Write a short contract describing the input, output, owner, and failure behavior for Parquet, Arrow, and Columnar Storage.
