# Exercise: Backup, Restoration, Disaster Recovery, and Platform Handoff
...
1. Write a short contract describing the input, output, owner, and failure behavior for Backup, Restoration, Disaster Recovery, and Platform Handoff.
