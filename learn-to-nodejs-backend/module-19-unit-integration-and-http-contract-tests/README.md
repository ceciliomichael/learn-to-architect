# Module 19: Unit, Integration, and HTTP Contract Tests

## What you will learn

This module focuses on **Unit, Integration, and HTTP Contract Tests** as part of Node.js and TypeScript Backend Development. The goal is to understand the responsibility, use it in a production-oriented TypeScript API service running on Node.js, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Unit, Integration, and HTTP Contract Tests
...
Continue to [Module 20](../module-20-concurrency-load-tests-and-event-loop-evidence/README.md).