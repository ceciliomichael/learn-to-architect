# Exercise: Uploads, Webhooks, and Server-Side Request Forgery

Apply this module to the continuing project: a production-oriented TypeScript API service running on Node.js.

1. Write a short contract describing the input, output, owner, and failure behavior for Uploads, Webhooks, and Server-Side Request Forgery.
