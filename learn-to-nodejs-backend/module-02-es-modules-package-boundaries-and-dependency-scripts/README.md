# Module 02: ES Modules, Package Boundaries, and Dependency Scripts

## What you will learn

This module focuses on **ES Modules, Package Boundaries, and Dependency Scripts** as part of Node.js and TypeScript Backend Development. The goal is to understand the responsibility, use it in a production-oriented TypeScript API service running on Node.js, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Module boundaries define public imports and prevent unrelated code from reaching internal details.
- Package scripts should name repeatable development, type-check, test, build, and start commands.
- Review the resolved lock file and lifecycle scripts before trusting an installed dependency.
...
```text
Topic: ES Modules, Package Boundaries, and Dependency Scripts
...
Continue to [Module 03](../module-03-environment-validation-and-application-startup/README.md).