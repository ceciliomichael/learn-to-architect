# Module 18: Queues, Workers, Idempotency, and Dead Letters

## What you will learn

This module focuses on **Queues, Workers, Idempotency, and Dead Letters** as part of Node.js and TypeScript Backend Development. The goal is to understand the responsibility, use it in a production-oriented TypeScript API service running on Node.js, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Queues, Workers, Idempotency, and Dead Letters
...
Continue to [Module 19](../module-19-unit-integration-and-http-contract-tests/README.md).