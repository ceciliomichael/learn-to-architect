# Exercise: HTTP Servers, Requests, Responses, and Shutdown

Apply this module to the continuing project: a production-oriented TypeScript API service running on Node.js.

1. Write a short contract describing the input, output, owner, and failure behavior for HTTP Servers, Requests, Responses, and Shutdown.
