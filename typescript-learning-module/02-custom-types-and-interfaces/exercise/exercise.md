...
2. **[Challenge 02: Extend Blueprints Two Ways](./challenge-02.md)**  -  Practice code reuse! You will inherit animal properties into bird structures using both interface `extends` and type intersection `&` operators.
