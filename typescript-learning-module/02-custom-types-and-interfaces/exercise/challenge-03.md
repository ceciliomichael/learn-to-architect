# Challenge 03: Translation Dictionary with Index Signatures

You are building a word translation tool where the set of words is not known in advance.

## Your Tasks

1. Create an `interface` called `WordMap` using an index signature. Any string key must map to a string value.

2. Create a variable `spanishDict` typed as `WordMap` and populate it with at least 5 English-to-Spanish word pairs.
