# Exercise: End-to-End Testing and Production-Like Data
...
The project passes strict type checking and its behavior demonstrates this rule: End-to-end tests exercise a built application through real user flows with controlled production-like test data and reliable cleanup.