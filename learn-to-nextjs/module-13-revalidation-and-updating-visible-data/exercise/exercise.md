# Exercise: Revalidation and Updating Visible Data
...
The project passes strict type checking and its behavior demonstrates this rule: After a successful mutation, update or invalidate the cached view that represents the changed data so the next render tells the truth.