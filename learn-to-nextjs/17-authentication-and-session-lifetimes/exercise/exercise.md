# Exercise: Authentication and Session Lifetimes
...
The project passes strict type checking and its behavior demonstrates this rule: Authentication proves which session is making a request, and session design must define creation, rotation, expiry, revocation, and secure cookie behavior.