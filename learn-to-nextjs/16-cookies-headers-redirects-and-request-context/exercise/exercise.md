# Exercise: Cookies, Headers, Redirects, and Request Context
...
The project passes strict type checking and its behavior demonstrates this rule: Cookies and headers belong to the current request context, redirects end the current response path, and reading request-specific values can affect rendering and caching behavior.