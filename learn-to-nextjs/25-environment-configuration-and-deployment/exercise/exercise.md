# Exercise: Environment Configuration and Deployment
...
The project passes strict type checking and its behavior demonstrates this rule: Validate environment variables on the server, expose only explicitly public values, build in the deployment target, and document migrations, health checks, and rollback.