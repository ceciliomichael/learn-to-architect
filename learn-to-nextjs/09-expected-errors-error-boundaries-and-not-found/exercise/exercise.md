# Exercise: Expected Errors, Error Boundaries, and Not Found
...
The project passes strict type checking and its behavior demonstrates this rule: Return expected failures as ordinary states, use notFound for missing resources, and use an error boundary for unexpected rendering failures that need containment and recovery.