# Exercise: Forms, Runtime Validation, and Action State
...
The project passes strict type checking and its behavior demonstrates this rule: Forms should work with browser semantics first, validate on the server, preserve entered values when useful, and expose pending and field errors through accessible action state.