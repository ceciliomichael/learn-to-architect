# Module 10: SQLAlchemy Mapping without Hiding SQL

## What you will learn

This module focuses on **SQLAlchemy Mapping without Hiding SQL** as part of Python Backend Development. The goal is to understand the responsibility, use it in a production-oriented Python API service using ASGI and FastAPI, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: SQLAlchemy Mapping without Hiding SQL
...
Continue to [Module 11](../module-11-resource-design-pagination-and-concurrency/README.md).