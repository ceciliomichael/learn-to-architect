# Module 24: Django as an Optional Full Web Application Branch

## What you will learn

This module focuses on **Django as an Optional Full Web Application Branch** as part of Python Backend Development. The goal is to understand the responsibility, use it in a production-oriented Python API service using ASGI and FastAPI, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Django provides an integrated ORM, migrations, authentication, forms, templates, and administration for full web applications.
- Choose it when the integrated stack fits the product rather than layering it beside FastAPI by default.
- Preserve the same validation, authorization, transaction, testing, and deployment boundaries.
...
```text
Topic: Django as an Optional Full Web Application Branch
Project: a production-oriented Python API service using ASGI and FastAPI
...
Return to the [Backend Engineering Learning Path](../../learning-paths/backend-development.md).