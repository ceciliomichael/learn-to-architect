# Exercise: Path, Query, Header, Cookie, and Body Input

Apply this module to the continuing project: a production-oriented Python API service using ASGI and FastAPI.

1. Write a short contract describing the input, output, owner, and failure behavior for Path, Query, Header, Cookie, and Body Input.
