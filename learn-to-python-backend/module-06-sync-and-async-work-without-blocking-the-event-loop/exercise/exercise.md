# Exercise: Sync and Async Work without Blocking the Event Loop

Apply this module to the continuing project: a production-oriented Python API service using ASGI and FastAPI.

1. Write a short contract describing the input, output, owner, and failure behavior for Sync and Async Work without Blocking the Event Loop.
