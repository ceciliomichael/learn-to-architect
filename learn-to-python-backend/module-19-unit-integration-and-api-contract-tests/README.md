# Module 19: Unit, Integration, and API Contract Tests

## What you will learn

This module focuses on **Unit, Integration, and API Contract Tests** as part of Python Backend Development. The goal is to understand the responsibility, use it in a production-oriented Python API service using ASGI and FastAPI, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Unit, Integration, and API Contract Tests
...
Continue to [Module 20](../module-20-async-tests-concurrency-and-failure-injection/README.md).