# Module 03: Configuration Properties, Profiles, and Secrets

## What you will learn

This module focuses on **Configuration Properties, Profiles, and Secrets** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Grant only the files, network destinations, database actions, and secrets required for the current responsibility.
- Separate human identity, service identity, and resource authorization.
- Rotate credentials without rebuilding source code and never place secrets in logs.
...
```text
Topic: Configuration Properties, Profiles, and Secrets
...
Continue to [Module 04](../module-04-embedded-servers-startup-and-graceful-shutdown/README.md).