# Module 24: JVM Resources, Dependency Security, and Hardening

## What you will learn

This module focuses on **JVM Resources, Dependency Security, and Hardening** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: JVM Resources, Dependency Security, and Hardening
...
Continue to [Module 25](../module-25-container-builds-deployment-rollout-and-maintenance/README.md).