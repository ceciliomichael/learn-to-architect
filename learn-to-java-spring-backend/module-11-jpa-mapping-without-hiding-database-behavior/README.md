# Module 11: JPA Mapping without Hiding Database Behavior

## What you will learn

This module focuses on **JPA Mapping without Hiding Database Behavior** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: JPA Mapping without Hiding Database Behavior
...
Continue to [Module 12](../module-12-resource-design-pagination-and-concurrency/README.md).