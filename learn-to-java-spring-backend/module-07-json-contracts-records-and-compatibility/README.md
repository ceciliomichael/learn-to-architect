# Module 07: JSON Contracts, Records, and Compatibility

## What you will learn

This module focuses on **JSON Contracts, Records, and Compatibility** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: JSON Contracts, Records, and Compatibility
...
Continue to [Module 08](../module-08-service-boundaries-and-transaction-ownership/README.md).