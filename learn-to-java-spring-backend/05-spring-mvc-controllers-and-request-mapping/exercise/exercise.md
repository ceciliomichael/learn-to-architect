# Exercise: Spring MVC Controllers and Request Mapping

Apply this module to the continuing project: a production-oriented Java service using Spring Boot and Spring MVC.

1. Write a short contract describing the input, output, owner, and failure behavior for Spring MVC Controllers and Request Mapping.
