# Module 02: Application Context, Beans, and Dependency Injection

## What you will learn

This module focuses on **Application Context, Beans, and Dependency Injection** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Spring Boot starters assemble related dependencies and auto-configuration, but generated choices still require review.
- The application context creates and connects beans according to explicit configuration and discovered metadata.
- Constructor injection makes required dependencies visible and keeps domain objects testable.
...
```text
Topic: Application Context, Beans, and Dependency Injection
...
Continue to [Module 03](../module-03-configuration-properties-profiles-and-secrets/README.md).