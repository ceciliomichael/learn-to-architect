# Module 23: Actuator, Logs, Metrics, Traces, and Health

## What you will learn

This module focuses on **Actuator, Logs, Metrics, Traces, and Health** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Actuator, Logs, Metrics, Traces, and Health
...
Continue to [Module 24](../module-24-jvm-resources-dependency-security-and-hardening/README.md).