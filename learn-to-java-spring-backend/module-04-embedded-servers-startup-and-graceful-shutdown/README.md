# Module 04: Embedded Servers, Startup, and Graceful Shutdown

## What you will learn

This module focuses on **Embedded Servers, Startup, and Graceful Shutdown** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Embedded Servers, Startup, and Graceful Shutdown
...
Continue to [Module 05](../module-05-spring-mvc-controllers-and-request-mapping/README.md).