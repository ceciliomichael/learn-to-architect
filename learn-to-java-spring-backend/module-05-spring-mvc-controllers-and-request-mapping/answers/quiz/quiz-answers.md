# Quiz Answers: Spring MVC Controllers and Request Mapping

1. **What responsibility does this module add to the continuing project?**

   It adds Spring MVC Controllers and Request Mapping with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
