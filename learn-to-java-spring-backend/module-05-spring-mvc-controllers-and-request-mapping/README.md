# Module 05: Spring MVC Controllers and Request Mapping

## What you will learn

This module focuses on **Spring MVC Controllers and Request Mapping** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Spring MVC Controllers and Request Mapping
...
Continue to [Module 06](../module-06-request-validation-and-stable-error-responses/README.md).