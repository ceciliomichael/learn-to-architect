# Module 19: External HTTP Clients, Timeouts, Retries, and Limits

## What you will learn

This module focuses on **External HTTP Clients, Timeouts, Retries, and Limits** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: External HTTP Clients, Timeouts, Retries, and Limits
...
Continue to [Module 20](../module-20-caching-messaging-workers-and-idempotency/README.md).