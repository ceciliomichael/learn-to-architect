# Module 21: JUnit Unit Tests and Spring Slice Tests

## What you will learn

This module focuses on **JUnit Unit Tests and Spring Slice Tests** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: JUnit Unit Tests and Spring Slice Tests
...
Continue to [Module 22](../module-22-database-integration-and-http-end-to-end-tests/README.md).