# Exercise: Container Builds, Deployment, Rollout, and Maintenance

Apply this module to the continuing project: a production-oriented Java service using Spring Boot and Spring MVC.

1. Write a short contract describing the input, output, owner, and failure behavior for Container Builds, Deployment, Rollout, and Maintenance.
