# Module 09: JDBC Pools, Parameterized SQL, and Repositories

## What you will learn

This module focuses on **JDBC Pools, Parameterized SQL, and Repositories** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: JDBC Pools, Parameterized SQL, and Repositories
...
Continue to [Module 10](../module-10-schema-migrations-and-transaction-isolation/README.md).