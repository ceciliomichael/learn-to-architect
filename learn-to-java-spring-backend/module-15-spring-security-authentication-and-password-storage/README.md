# Module 15: Spring Security Authentication and Password Storage

## What you will learn

This module focuses on **Spring Security Authentication and Password Storage** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Spring Security Authentication and Password Storage
...
Continue to [Module 16](../module-16-oauth-resource-servers-and-token-validation/README.md).