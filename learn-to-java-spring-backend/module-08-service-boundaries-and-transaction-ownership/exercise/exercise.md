# Exercise: Service Boundaries and Transaction Ownership

Apply this module to the continuing project: a production-oriented Java service using Spring Boot and Spring MVC.

1. Write a short contract describing the input, output, owner, and failure behavior for Service Boundaries and Transaction Ownership.
