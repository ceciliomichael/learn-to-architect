# Quiz Answers: JPA Mapping without Hiding Database Behavior

1. **What responsibility does this module add to the continuing project?**

   It adds JPA Mapping without Hiding Database Behavior with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
