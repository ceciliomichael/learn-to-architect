# Module 01: Spring Boot Projects, Starters, and Generated Files

## What you will learn

This module focuses on **Spring Boot Projects, Starters, and Generated Files** as part of Java and Spring Backend Development. The goal is to understand the responsibility, use it in a production-oriented Java service using Spring Boot and Spring MVC, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Spring Boot Projects, Starters, and Generated Files
...
Continue to [Module 02](../module-02-application-context-beans-and-dependency-injection/README.md).