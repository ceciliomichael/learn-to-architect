# Module 14: External Clients, Retries, and Circuit Breaking

## What you will learn

This module focuses on **External Clients, Retries, and Circuit Breaking** as part of Go Backend Development. The goal is to understand the responsibility, use it in a production-oriented Go HTTP service built from standard-library boundaries, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: External Clients, Retries, and Circuit Breaking
Project: a production-oriented Go HTTP service built from standard-library boundaries
...
Continue to [Module 15](../module-15-caching-queues-workers-and-idempotency/README.md).