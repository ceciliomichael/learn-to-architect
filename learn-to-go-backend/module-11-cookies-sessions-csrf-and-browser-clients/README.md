# Module 11: Cookies, Sessions, CSRF, and Browser Clients

## What you will learn

This module focuses on **Cookies, Sessions, CSRF, and Browser Clients** as part of Go Backend Development. The goal is to understand the responsibility, use it in a production-oriented Go HTTP service built from standard-library boundaries, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Cookies, Sessions, CSRF, and Browser Clients
...
Continue to [Module 12](../module-12-token-validation-roles-ownership-and-tenancy/README.md).