# Exercise: Cookies, Sessions, CSRF, and Browser Clients

Apply this module to the continuing project: a production-oriented Go HTTP service built from standard-library boundaries.

1. Write a short contract describing the input, output, owner, and failure behavior for Cookies, Sessions, CSRF, and Browser Clients.
