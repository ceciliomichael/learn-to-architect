# Module 21: Deployment, Migrations, Rollout, and Rollback

## What you will learn

This module focuses on **Deployment, Migrations, Rollout, and Rollback** as part of Go Backend Development. The goal is to understand the responsibility, use it in a production-oriented Go HTTP service built from standard-library boundaries, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Deployment, Migrations, Rollout, and Rollback
...
Continue to [Module 22](../module-22-profiles-compatibility-and-long-term-maintenance/README.md).