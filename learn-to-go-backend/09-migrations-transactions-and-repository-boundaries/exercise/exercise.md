# Exercise: Migrations, Transactions, and Repository Boundaries

Apply this module to the continuing project: a production-oriented Go HTTP service built from standard-library boundaries.

1. Write a short contract describing the input, output, owner, and failure behavior for Migrations, Transactions, and Repository Boundaries.
