# Module 18: Structured Logs, Metrics, Traces, and Health

## What you will learn

This module focuses on **Structured Logs, Metrics, Traces, and Health** as part of Go Backend Development. The goal is to understand the responsibility, use it in a production-oriented Go HTTP service built from standard-library boundaries, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Structured Logs, Metrics, Traces, and Health
...
Continue to [Module 19](../module-19-dependency-review-and-production-hardening/README.md).