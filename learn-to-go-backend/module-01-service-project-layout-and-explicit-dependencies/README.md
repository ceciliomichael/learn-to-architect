# Module 01: Service Project Layout and Explicit Dependencies

## What you will learn

This module focuses on **Service Project Layout and Explicit Dependencies** as part of Go Backend Development. The goal is to understand the responsibility, use it in a production-oriented Go HTTP service built from standard-library boundaries, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
- Keep source, generated output, configuration, and local data in distinct locations.
- Record tool versions and repeatable commands so another learner can recreate the environment.
- Use disposable data and inspect every command before running it.
...
```text
Topic: Service Project Layout and Explicit Dependencies
...
Continue to [Module 02](../module-02-http-server-configuration-and-graceful-shutdown/README.md).