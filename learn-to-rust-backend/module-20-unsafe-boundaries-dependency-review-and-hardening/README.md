# Module 20: Unsafe Boundaries, Dependency Review, and Hardening

## What you will learn

This module focuses on **Unsafe Boundaries, Dependency Review, and Hardening** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Unsafe Boundaries, Dependency Review, and Hardening
...
Continue to [Module 21](../module-21-container-images-and-runtime-resource-limits/README.md).