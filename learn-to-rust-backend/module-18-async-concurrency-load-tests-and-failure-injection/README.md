# Module 18: Async Concurrency, Load Tests, and Failure Injection

## What you will learn

This module focuses on **Async Concurrency, Load Tests, and Failure Injection** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Async Concurrency, Load Tests, and Failure Injection
Project: a production-oriented Rust API service using Tokio and Axum
...
Continue to [Module 19](../module-19-tracing-metrics-health-and-diagnostic-context/README.md).