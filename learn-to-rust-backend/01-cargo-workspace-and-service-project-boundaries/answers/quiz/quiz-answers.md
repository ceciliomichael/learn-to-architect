# Quiz Answers: Cargo Workspace and Service Project Boundaries

1. **What responsibility does this module add to the continuing project?**

   It adds Cargo Workspace and Service Project Boundaries with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
