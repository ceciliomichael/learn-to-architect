# Exercise: Timeouts, Cancellation, and Graceful Shutdown

Apply this module to the continuing project: a production-oriented Rust API service using Tokio and Axum.

1. Write a short contract describing the input, output, owner, and failure behavior for Timeouts, Cancellation, and Graceful Shutdown.
