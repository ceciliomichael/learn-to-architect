# Module 17: Unit, Integration, and HTTP Contract Tests

## What you will learn

This module focuses on **Unit, Integration, and HTTP Contract Tests** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
Continue to [Module 18](../module-18-async-concurrency-load-tests-and-failure-injection/README.md).