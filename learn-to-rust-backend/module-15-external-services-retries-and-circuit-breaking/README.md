# Module 15: External Services, Retries, and Circuit Breaking

## What you will learn

This module focuses on **External Services, Retries, and Circuit Breaking** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: External Services, Retries, and Circuit Breaking
...
Continue to [Module 16](../module-16-caching-queues-workers-and-idempotency/README.md).