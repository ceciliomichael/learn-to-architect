# Exercise: Container Images and Runtime Resource Limits

Apply this module to the continuing project: a production-oriented Rust API service using Tokio and Axum.

1. Write a short contract describing the input, output, owner, and failure behavior for Container Images and Runtime Resource Limits.
