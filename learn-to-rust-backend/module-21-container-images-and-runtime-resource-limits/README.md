# Module 21: Container Images and Runtime Resource Limits

## What you will learn

This module focuses on **Container Images and Runtime Resource Limits** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Container Images and Runtime Resource Limits
...
Continue to [Module 22](../module-22-deployment-migrations-rollout-and-rollback/README.md).