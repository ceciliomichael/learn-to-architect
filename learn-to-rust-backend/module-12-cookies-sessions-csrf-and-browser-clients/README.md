...
This module focuses on **Cookies, Sessions, CSRF, and Browser Clients** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
Continue to [Module 13](../module-13-token-validation-roles-ownership-and-tenancy/README.md).