# Module 22: Deployment, Migrations, Rollout, and Rollback

## What you will learn

This module focuses on **Deployment, Migrations, Rollout, and Rollback** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
Continue to [Module 23](../module-23-performance-evidence-compatibility-and-maintenance/README.md).