# Exercise: Async Concurrency, Load Tests, and Failure Injection

Apply this module to the continuing project: a production-oriented Rust API service using Tokio and Axum.

1. Write a short contract describing the input, output, owner, and failure behavior for Async Concurrency, Load Tests, and Failure Injection.
