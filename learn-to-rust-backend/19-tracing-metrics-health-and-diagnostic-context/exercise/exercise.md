# Exercise: Tracing, Metrics, Health, and Diagnostic Context

Apply this module to the continuing project: a production-oriented Rust API service using Tokio and Axum.

1. Write a short contract describing the input, output, owner, and failure behavior for Tracing, Metrics, Health, and Diagnostic Context.
