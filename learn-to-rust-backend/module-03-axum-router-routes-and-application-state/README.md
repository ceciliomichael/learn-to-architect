# Module 03: Axum Router, Routes, and Application State

## What you will learn

This module focuses on **Axum Router, Routes, and Application State** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Axum Router, Routes, and Application State
...
Continue to [Module 04](../module-04-extractors-requests-and-runtime-validation/README.md).