# Module 19: Tracing, Metrics, Health, and Diagnostic Context

## What you will learn

This module focuses on **Tracing, Metrics, Health, and Diagnostic Context** as part of Rust Backend Development. The goal is to understand the responsibility, use it in a production-oriented Rust API service using Tokio and Axum, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Tracing, Metrics, Health, and Diagnostic Context
...
Continue to [Module 20](../module-20-unsafe-boundaries-dependency-review-and-hardening/README.md).