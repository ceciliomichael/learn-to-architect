...
```text
Topic: Cargo Workspace and Service Project Boundaries
...
Continue to [Module 02](../module-02-tokio-runtime-ownership-and-async-tasks/README.md).