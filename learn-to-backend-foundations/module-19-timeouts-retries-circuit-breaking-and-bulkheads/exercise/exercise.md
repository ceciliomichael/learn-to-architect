# Exercise: Timeouts, Retries, Circuit Breaking, and Bulkheads
...
1. Write a short contract describing the input, output, owner, and failure behavior for Timeouts, Retries, Circuit Breaking, and Bulkheads.
