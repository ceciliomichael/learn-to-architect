# Exercise: Backend Responsibilities and the Request Lifecycle
...
1. Write a short contract describing the input, output, owner, and failure behavior for Backend Responsibilities and the Request Lifecycle.
