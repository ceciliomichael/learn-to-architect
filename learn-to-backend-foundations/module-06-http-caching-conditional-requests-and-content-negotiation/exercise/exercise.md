# Exercise: HTTP Caching, Conditional Requests, and Content Negotiation

Apply this module to the continuing project: a language-neutral HTTP service design that can be implemented in any backend track.

1. Write a short contract describing the input, output, owner, and failure behavior for HTTP Caching, Conditional Requests, and Content Negotiation.
