# Exercise: Secrets, Dependency Trust, and Secure Defaults
...
1. Write a short contract describing the input, output, owner, and failure behavior for Secrets, Dependency Trust, and Secure Defaults.
