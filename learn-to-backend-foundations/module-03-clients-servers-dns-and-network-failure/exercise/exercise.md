# Exercise: Clients, Servers, DNS, and Network Failure
...
1. Write a short contract describing the input, output, owner, and failure behavior for Clients, Servers, DNS, and Network Failure.
