# Exercise: Terminals, Processes, Ports, and Environment Values
...
1. Write a short contract describing the input, output, owner, and failure behavior for Terminals, Processes, Ports, and Environment Values.
