# Exercise: Cookies, Sessions, Origins, CORS, and CSRF
...
1. Write a short contract describing the input, output, owner, and failure behavior for Cookies, Sessions, Origins, CORS, and CSRF.
