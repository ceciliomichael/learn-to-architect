# Exercise: Idempotency, Concurrency Tokens, and Repeated Requests
...
1. Write a short contract describing the input, output, owner, and failure behavior for Idempotency, Concurrency Tokens, and Repeated Requests.
