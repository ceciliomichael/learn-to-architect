# Exercise: Modular Monoliths, Service Boundaries, and Evolution
...
1. Write a short contract describing the input, output, owner, and failure behavior for Modular Monoliths, Service Boundaries, and Evolution.
