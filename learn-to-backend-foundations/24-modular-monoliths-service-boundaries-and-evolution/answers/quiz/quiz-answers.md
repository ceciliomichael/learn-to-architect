# Quiz Answers: Modular Monoliths, Service Boundaries, and Evolution

1. **What responsibility does this module add to the continuing project?**

   It adds Modular Monoliths, Service Boundaries, and Evolution with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
