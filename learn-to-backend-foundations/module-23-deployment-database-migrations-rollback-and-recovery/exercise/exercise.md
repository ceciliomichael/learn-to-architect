# Exercise: Deployment, Database Migrations, Rollback, and Recovery
...
1. Write a short contract describing the input, output, owner, and failure behavior for Deployment, Database Migrations, Rollback, and Recovery.
