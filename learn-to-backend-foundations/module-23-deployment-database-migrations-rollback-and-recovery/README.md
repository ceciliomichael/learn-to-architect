# Module 23: Deployment, Database Migrations, Rollback, and Recovery

## What you will learn

This module focuses on **Deployment, Database Migrations, Rollback, and Recovery** as part of Backend Foundations. The goal is to understand the responsibility, use it in a language-neutral HTTP service design that can be implemented in any backend track, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Deployment, Database Migrations, Rollback, and Recovery
...
Continue to [Module 24](../module-24-modular-monoliths-service-boundaries-and-evolution/README.md).