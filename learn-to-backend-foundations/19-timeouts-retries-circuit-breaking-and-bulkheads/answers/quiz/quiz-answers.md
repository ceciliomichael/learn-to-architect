# Quiz Answers: Timeouts, Retries, Circuit Breaking, and Bulkheads

1. **What responsibility does this module add to the continuing project?**

   It adds Timeouts, Retries, Circuit Breaking, and Bulkheads with an explicit input contract, owned rule, controlled side effects, failure behavior, and verification evidence.
