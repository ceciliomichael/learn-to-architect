# Exercise: URLs, Methods, Headers, Bodies, and Status Codes
...
1. Write a short contract describing the input, output, owner, and failure behavior for URLs, Methods, Headers, Bodies, and Status Codes.
