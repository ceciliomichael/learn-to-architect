# Exercise: Pagination, Filtering, Sorting, and Search
...
1. Write a short contract describing the input, output, owner, and failure behavior for Pagination, Filtering, Sorting, and Search.
