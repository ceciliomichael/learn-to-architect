# Module 08: Routing, Handlers, Middleware, and Execution Order

## What you will learn

This module focuses on **Routing, Handlers, Middleware, and Execution Order** as part of Backend Foundations. The goal is to understand the responsibility, use it in a language-neutral HTTP service design that can be implemented in any backend track, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Routing, Handlers, Middleware, and Execution Order
...
Continue to [Module 09](../module-09-transport-business-rules-and-data-access-boundaries/README.md).