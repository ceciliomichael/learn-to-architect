# Module 14: Idempotency, Concurrency Tokens, and Repeated Requests

## What you will learn

This module focuses on **Idempotency, Concurrency Tokens, and Repeated Requests** as part of Backend Foundations. The goal is to understand the responsibility, use it in a language-neutral HTTP service design that can be implemented in any backend track, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Idempotency, Concurrency Tokens, and Repeated Requests
...
Continue to [Module 15](../module-15-openapi-compatibility-deprecation-and-versioning/README.md).