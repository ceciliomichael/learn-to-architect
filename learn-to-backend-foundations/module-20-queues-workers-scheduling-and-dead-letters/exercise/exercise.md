# Exercise: Queues, Workers, Scheduling, and Dead Letters
...
1. Write a short contract describing the input, output, owner, and failure behavior for Queues, Workers, Scheduling, and Dead Letters.
