# Module 20: Queues, Workers, Scheduling, and Dead Letters

## What you will learn

This module focuses on **Queues, Workers, Scheduling, and Dead Letters** as part of Backend Foundations. The goal is to understand the responsibility, use it in a language-neutral HTTP service design that can be implemented in any backend track, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Queues, Workers, Scheduling, and Dead Letters
...
Continue to [Module 21](../module-21-logs-metrics-traces-health-and-service-levels/README.md).