# Exercise: Startup, Readiness, Graceful Shutdown, and Cancellation
...
1. Write a short contract describing the input, output, owner, and failure behavior for Startup, Readiness, Graceful Shutdown, and Cancellation.
