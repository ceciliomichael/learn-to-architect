# Exercise: TLS, Certificates, Proxies, and Trusted Hops
...
1. Write a short contract describing the input, output, owner, and failure behavior for TLS, Certificates, Proxies, and Trusted Hops.
