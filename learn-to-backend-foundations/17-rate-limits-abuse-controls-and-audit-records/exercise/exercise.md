# Exercise: Rate Limits, Abuse Controls, and Audit Records
...
1. Write a short contract describing the input, output, owner, and failure behavior for Rate Limits, Abuse Controls, and Audit Records.
