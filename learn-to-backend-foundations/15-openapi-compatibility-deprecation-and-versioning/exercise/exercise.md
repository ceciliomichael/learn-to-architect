# Exercise: OpenAPI, Compatibility, Deprecation, and Versioning
...
1. Write a short contract describing the input, output, owner, and failure behavior for OpenAPI, Compatibility, Deprecation, and Versioning.
