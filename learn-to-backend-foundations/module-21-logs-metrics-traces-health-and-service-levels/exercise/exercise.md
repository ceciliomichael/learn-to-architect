# Exercise: Logs, Metrics, Traces, Health, and Service Levels
...
1. Write a short contract describing the input, output, owner, and failure behavior for Logs, Metrics, Traces, Health, and Service Levels.
