# Module 22: Containers, Configuration, and Non-Root Processes

## What you will learn

This module focuses on **Containers, Configuration, and Non-Root Processes** as part of Backend Foundations. The goal is to understand the responsibility, use it in a language-neutral HTTP service design that can be implemented in any backend track, and collect evidence that the result remains correct when input, dependencies, or timing change.
...
```text
Topic: Containers, Configuration, and Non-Root Processes
...
Continue to [Module 23](../module-23-deployment-database-migrations-rollback-and-recovery/README.md).