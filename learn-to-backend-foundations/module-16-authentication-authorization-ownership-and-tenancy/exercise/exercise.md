# Exercise: Authentication, Authorization, Ownership, and Tenancy
...
1. Write a short contract describing the input, output, owner, and failure behavior for Authentication, Authorization, Ownership, and Tenancy.
