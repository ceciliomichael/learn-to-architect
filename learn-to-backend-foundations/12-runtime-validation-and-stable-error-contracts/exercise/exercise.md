# Exercise: Runtime Validation and Stable Error Contracts
...
1. Write a short contract describing the input, output, owner, and failure behavior for Runtime Validation and Stable Error Contracts.
