# Exercise: Containers, Configuration, and Non-Root Processes
...
1. Write a short contract describing the input, output, owner, and failure behavior for Containers, Configuration, and Non-Root Processes.
