# Exercise: Component and End-to-End Testing
...
The project passes strict type checking and its behavior demonstrates this rule: Component tests assert visible behavior through accessible queries, and end-to-end tests exercise critical browser flows against controlled data.