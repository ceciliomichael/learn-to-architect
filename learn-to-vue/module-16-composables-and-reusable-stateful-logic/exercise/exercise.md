# Exercise: Composables and Reusable Stateful Logic
...
The project passes strict type checking and its behavior demonstrates this rule: A composable is a function that uses Vue reactivity to reuse stateful behavior. Each call owns its state unless a shared owner is intentionally defined.