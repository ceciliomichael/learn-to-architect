# Exercise: Template Syntax and Safe Expressions
...
The project passes strict type checking and its behavior demonstrates this rule: Vue templates are HTML-like declarations with directives and JavaScript expressions. Interpolation escapes text, while directives control attributes and behavior.