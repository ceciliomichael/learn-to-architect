# Exercise: Component v-model and Fallthrough Attributes
...
The project passes strict type checking and its behavior demonstrates this rule: Component v-model is a prop and update event contract, while fallthrough attributes let a wrapper preserve useful HTML attributes and listeners on the intended root element.