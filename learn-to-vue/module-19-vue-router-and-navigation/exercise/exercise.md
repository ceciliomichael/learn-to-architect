# Exercise: Vue Router and Navigation
...
The project passes strict type checking and its behavior demonstrates this rule: Vue Router maps URLs to views, preserves real links, parses route values as untrusted input, and supports nested layouts and navigation guards.